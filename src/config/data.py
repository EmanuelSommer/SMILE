...
class Task(str, Enum):
    ...
    CLASSIFICATION_MULTILABEL = "class_multilabel"
...
class DataConfig(BaseConfig):
    ...
    Note:
        Handling the I/O pre-processing, post-processing of the data should be defined
        in the `src.dataset` module, this class is only responsible for
    ...
    augment: str = field(
        default="identity",
        metadata={
            "description": "Augmentation to be applied to the data, curr: basic,identity.",
            "searchable": True,
        },
    )
