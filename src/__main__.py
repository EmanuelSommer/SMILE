...
from src.utils import configure_xla_flags
...
def main(
    ...
    """Run main."""
    from src.config.core import Config  # don't slow down --help flag
...
parser = argparse.ArgumentParser(
    prog="python -m src",
    description="fast, modular and scalable sampling-based inference for Bayesian neural networks",
    epilog=help,
